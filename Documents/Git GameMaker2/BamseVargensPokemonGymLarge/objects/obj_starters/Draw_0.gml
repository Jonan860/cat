...
draw_text(x-sprite_width*(1/2+1/8),y,"HP:"+string(HP))
status_text=""
concatonateAilmentText()
...
if(global.phase=statusAilment.implementationPhase){statusAilment.draw()}
}
...
function concatonateAilmentText(){
for(i=0;i<ds_list_size(statusAilmentList);i++){
var statusAilment = ds_list_find_value(statusAilmentList, i)
