...
if(global.phase=PHASES.awakening and active){draw_sprite(spr_uttropstecken,-1,x+sprite_width/2,y-sprite_height/2)}

if(global.phase=PHASES.nightmared and active){draw_sprite(spr_nightmare,-1,x,y)}
