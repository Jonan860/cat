if(global.phase=="Amber defence_curl_hit2" or global.phase="Amber defence_curl_miss2"){sprite_index=spr_defence_curl_squirtle}
...
if (global.phase=="Amber defence_curl_hit2"){draw_sprite(spr_defence_curl_squirtle,0,x,y)}
...
if(room==winner){event_inherited()}
