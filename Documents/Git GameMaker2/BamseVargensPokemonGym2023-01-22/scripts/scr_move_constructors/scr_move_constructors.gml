...
damage_=0, elementalType_=ELEMENTALTYPES.normal,scrEffect_=moveDamageEffect, ppMax_=0, scrStart_=scr_perform_start,scrEnd_=moveEnd,critChance_=7.5,accuracy_=1,damageParadigm_=DAMAGEPARADIGMS.normal, scrMissEffect_=doNothing, willHaveAnEffect_=function(){return 1})constructor{
	animator = animator_
	ppMax=ppMax_
	pp=ppMax_
	button=button_
